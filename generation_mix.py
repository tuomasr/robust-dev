...
input_files = [
    "result_files2/scenarios_15_benders_dc_miqp_dc_ub=4_increase=0.05_no_emissions/operation_decisions.pickle",
...
plt.savefig("generation_mixes.png", bbox_inches="tight")
