...
input_files = [
    ...
    "result_files2/scenarios_15_benders_dc_miqp_dc_ub=4_increase=0.05_no_emissions_price_multiplier=1e4/operation_decisions.pickle",
]
...
plt.savefig("generation_mixes_diff.png", bbox_inches="tight")
